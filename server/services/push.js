// Web Push runtime — config VAPID, public key, send (low-level).
//
// Portado do impgeo (services/push.js). Mesmo módulo, sem mudanças
// semânticas — Web Push é igual em qualquer projeto.
//
// Centralizado aqui em vez de inline no server.js pra:
//   1. Não acoplar a config de VAPID ao boot do Express.
//   2. Permitir que o dispatcher reutilize a mesma instância.
