...
<h2>Termos de Uso</h2>
<p>Bem-vindo ao <strong>Alya</strong>. Ao utilizar este sistema, você concorda com os presentes Termos de Uso.</p>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 w-full max-w-2xl max-h-[85vh] flex flex-col">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100 dark:border-gray-800 flex-shrink-0">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="font-bold text-gray-900 dark:text-gray-100 text-base leading-tight">Termos de Uso</h2>
