...
const SortableLinkItem: React.FC<SortableLinkItemProps> = ({ link, onEdit, onDelete }) => {
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className="flex items-center gap-2 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg px-3 py-2 group"
    >
      <button {...attributes} {...listeners} className="cursor-grab text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 flex-shrink-0">
      ...
      <button
        onClick={() => onEdit(link)}
        className="text-gray-400 hover:text-amber-600 dark:hover:text-amber-400 flex-shrink-0 transition-colors"
      >
...
const SortableColuna: React.FC<SortableColunaProps> = ({
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-4 min-w-[220px] max-w-[280px] flex-shrink-0"
    >
      {/* Header da coluna */}
        ...
        {editandoTitulo ? (
          <div className="flex items-center gap-1 flex-1">
            <input
              ...
              autoFocus
              className="flex-1 text-sm font-semibold border-b border-amber-400 bg-transparent outline-none text-gray-800 dark:text-gray-100 py-0.5"
            />
          </div>
        ) : (
          <span
            className="flex-1 text-sm font-semibold text-gray-800 dark:text-gray-100 cursor-pointer hover:text-amber-600 dark:hover:text-amber-400 truncate"
        ...
        <SortableContext items={coluna.links.map(l => l.id)} strategy={verticalListSortingStrategy}>
          <div className="space-y-1.5 min-h-[40px]">
            {coluna.links.length === 0 && (
              <p className="text-xs text-gray-400 dark:text-gray-500 text-center py-2 italic">Sem links ainda</p>
            )}
      ...
      <button
        ...
        className="mt-2 w-full flex items-center justify-center gap-1 text-xs text-amber-600 dark:text-amber-400 border border-dashed border-amber-300 dark:border-amber-600 rounded-lg py-1.5 hover:bg-amber-50 dark:hover:bg-amber-900/20 transition-colors"
      >
...
const SortableBottomLinkItem: React.FC<SortableBottomLinkItemProps> = ({ link, onEdit, onDelete, onToggleAtivo }) => {
  ...
  return (
    ...
    >
      ...
      <button onClick={() => onEdit(link)} className="flex-shrink-0 text-gray-400 hover:text-amber-600 dark:hover:text-amber-400 transition-colors">
...
const FooterManagement: React.FC = () => {
  ...
  const loadData = useCallback(async () => {
    try {
      ...
      // Bottom links (carregado separadamente para não depender do endpoint público)
  ...
  const aplicarNegrito = () => {
    ...
    if (start === end) return; // sem seleção
    const selecao = value.slice(start, end);
    // Toggle: se já tem **, remove; caso contrário, adiciona
    ...
    <div>
            ...
            <button
              ...
              className={`flex items-center gap-2 px-5 py-2.5 rounded-2xl font-semibold text-sm transition-all duration-200 shadow-sm ${
                activeTab === tab.id
                  ...
                  : 'bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-700 hover:border-amber-300 hover:text-amber-600'
              }`}
            >
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-amber-400 to-orange-400 text-white font-semibold rounded-xl hover:from-amber-500 hover:to-orange-500 shadow-lg transition-all text-sm"
            >
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-200 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-amber-500 text-sm"
              />
            </div>
            <div>
              <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-4 py-3 border border-gray-200 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-amber-500 text-sm resize-none"
              />
            </div>
            <div>
              <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                Texto do Autor / Registro
              </label>
              <input
                type="text"
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-200 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-amber-500 text-sm font-mono"
              />
            </div>
            <button
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  {config.empresa_autor && (
                    <p className="text-amber-100 text-xs mt-2">{config.empresa_autor}</p>
                  )}
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div>
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-4">
              ...
              Use <code className="bg-gray-100 dark:bg-gray-700 px-1 rounded text-amber-600 font-mono">**texto**</code> para <strong>negrito</strong>.
            </p>
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-xl border text-sm font-medium transition-all ${
                      config.info_alinhamento === valor
                        ...
                        : 'bg-white dark:bg-gray-700 border-gray-200 dark:border-gray-600 text-gray-600 dark:text-gray-300 hover:border-amber-400'
                    }`}
                  >
            ...
            <div className="mb-1 flex gap-1">
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg text-sm text-gray-600 dark:text-gray-300 hover:border-amber-400 hover:text-amber-600 dark:hover:text-amber-400 transition-all font-semibold"
              >
            ...
            <textarea
              ...
              className="w-full px-4 py-3 border border-gray-200 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-amber-500 text-sm resize-none font-mono"
            />
          ...
          <div>
            ...
            <div className="bg-gradient-to-r from-amber-600 to-orange-600 rounded-xl p-5">
              {config.info_texto.trim() ? (
                <div className="border-t border-b border-amber-500 py-4">
                  <div
                ...
                <div className="border-t border-b border-amber-500/50 py-4 text-center text-amber-200/50 text-xs italic">
      ...
      {activeTab === 'inferior' && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div>
            <p className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Preview</p>
            <div className="bg-gradient-to-r from-amber-600 to-orange-600 rounded-xl p-5">
              <div className="border-t border-amber-500 pt-4 text-center text-amber-100 text-sm">
          ...
          <div className="flex items-start justify-between mb-4 gap-4">
            <div>
              ...
              {bottomLinks.filter(l => l.ativo).length > 0 && (
                <div className="mt-3 flex flex-wrap items-center gap-x-0 text-xs text-amber-700 dark:text-amber-400 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700 rounded-xl px-4 py-2">
                  {bottomLinks.filter(l => l.ativo).map((item, idx, arr) => (
                    <span key={item.id} className="flex items-center">
                      <span className="px-1 font-medium">{item.texto}</span>
                      {idx < arr.length - 1 && <span className="text-amber-400 select-none">|</span>}
                    </span>
                  ))}
                </div>
              )}
            ...
            <button
              ...
              className="flex-shrink-0 flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-amber-400 to-orange-400 text-white font-semibold rounded-xl hover:from-amber-500 hover:to-orange-500 shadow-lg transition-all text-sm"
            >
              <Plus className="h-4 w-4" />
              Novo Link
            </button>
      ...
      {showModalLink && (
        <div className="fixed inset-0 bg-gradient-to-br from-amber-900/50 to-orange-900/50 backdrop-blur-sm flex items-center justify-center z-50 px-4">
          <div className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-6 w-full max-w-md shadow-2xl border border-gray-200/50 dark:border-gray-700">
            {/* Header */}
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/30 dark:to-orange-900/30 -mx-6 -mt-6 mb-6 px-6 py-4 border-b border-amber-200/50 dark:border-amber-700/50 rounded-t-2xl flex items-center justify-between">
              <h3 className="text-base font-bold text-gray-800 dark:text-gray-100">
                {linkEditando ? 'Editar Link' : 'Novo Link'}
              </h3>
              <button onClick={fecharModalLink} className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
                <X className="h-5 w-5" />
              </button>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-3 bg-gray-100 dark:bg-gray-700/50 rounded-xl">
                <div>
                  <p className="text-sm font-semibold text-gray-700 dark:text-gray-300">É um link clicável?</p>
                ...
                <button
                  ...
                  className={`relative w-11 h-6 rounded-full transition-colors ${linkEhLink ? 'bg-amber-500' : 'bg-gray-300 dark:bg-gray-600'}`}
                >
              ...
              <div className="flex gap-3 pt-2">
                <button
                  ...
                  className="flex-1 px-4 py-2.5 border border-gray-200 dark:border-gray-600 text-gray-600 dark:text-gray-300 rounded-xl font-semibold text-sm hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors disabled:opacity-50"
                >
                  Cancelar
                </button>
                <button
                  ...
                  disabled={isSavingLink}
                  className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-gradient-to-r from-amber-400 to-orange-400 text-white rounded-xl font-semibold text-sm hover:from-amber-500 hover:to-orange-500 transition-all disabled:opacity-50"
                >
                  {isSavingLink ? (
                    <><div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white" /> Salvando...</>
                  ) : (
      ...
      {deleteConfirm && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 px-4">
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 w-full max-w-sm shadow-2xl border border-red-200 dark:border-red-800">
        ...
        <div className="fixed inset-0 bg-gradient-to-br from-amber-900/50 to-orange-900/50 backdrop-blur-sm flex items-center justify-center z-50 px-4">
          <div className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-6 w-full max-w-md shadow-2xl border border-gray-200/50 dark:border-gray-700">
            ...
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/30 dark:to-orange-900/30 -mx-6 -mt-6 mb-6 px-6 py-4 border-b border-amber-200/50 dark:border-amber-700/50 rounded-t-2xl flex items-center justify-between">
              ...
              <button onClick={fecharModalBottom} className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
                <X className="h-5 w-5" />
              </button>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-3 bg-gray-100 dark:bg-gray-700/50 rounded-xl">
                <div>
                  <p className="text-sm font-semibold text-gray-700 dark:text-gray-300">Ativo</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                ...
                <button
                  ...
                  className={`relative w-11 h-6 rounded-full transition-colors ${bottomAtivo ? 'bg-amber-500' : 'bg-gray-300 dark:bg-gray-600'}`}
                >
