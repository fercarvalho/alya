...
const UserProfileModal: React.FC<UserProfileModalProps> = ({ isOpen, onClose }) => {
  ...
  const modalContent = (
    ...
    >
      <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl border border-gray-200/50">
        {/* Header */}
