...
const ImageCrop: React.FC<ImageCropProps> = ({
  ...
  const modalContent = (
    <div className="fixed inset-0 bg-gradient-to-br from-amber-900/50 to-orange-900/50 backdrop-blur-sm z-50 flex items-center justify-center px-4 pb-4 pt-[180px]">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[calc(100vh-220px)] flex flex-col">
        {/* Header */}
