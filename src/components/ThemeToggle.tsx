...
const ThemeToggle: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 left-6 z-40 group">
      <button
        onClick={toggleTheme}
        className="flex items-center justify-center w-14 h-14 bg-gradient-to-br from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105 active:scale-95"
