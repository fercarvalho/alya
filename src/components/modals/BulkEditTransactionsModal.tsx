...
/**
 * Edição em massa de transações selecionadas: aplica tipo, categoria e/ou
 * subcategoria em comum. Só os campos marcados são alterados. Tipos sem
 * categoria (transferência/caixa) escondem categoria/subcategoria.
 */
const BulkEditTransactionsModal: React.FC<Props> = ({ isOpen, count, subcategories, onClose, onApply }) => {
  ...
  // Se a regra muda o tipo para um sem categoria, categoria/subcategoria não se aplicam.
  ...
  return (
    <div
      className="fixed inset-0 z-[70] bg-gradient-to-br from-amber-900/50 to-orange-900/50 backdrop-blur-sm flex items-center justify-center px-4 pb-4 pt-[120px]"
