...
<p>Os dados são mantidos pelo tempo necessário para cumprir as finalidades descritas nesta política ou conforme exigido por lei.</p>
<h3>9. Contato — DPO</h3>
...
const PoliticaPrivacidadeModal: React.FC<PoliticaPrivacidadeModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div
      className="fixed inset-0 bg-black/60 dark:bg-black/75 flex items-center justify-center z-[10000] p-4"
      onClick={e => { if (e.target === e.currentTarget) onClose(); }}
    >
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 w-full max-w-2xl max-h-[85vh] flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100 dark:border-gray-800 flex-shrink-0">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="font-bold text-gray-900 dark:text-gray-100 text-base leading-tight">Política de Privacidade</h2>
          ...
          <button
            onClick={onClose}
            className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 transition-colors rounded-lg p-1.5 hover:bg-gray-100 dark:hover:bg-gray-800"
            aria-label="Fechar"
          >
            <X className="h-5 w-5" />
          </button>
        ...
        <div className="overflow-y-auto flex-1 px-5 py-4">
          {isLoading ? (
            ...
            <div
              className="prose-legal text-sm text-gray-700 dark:text-gray-300 leading-relaxed"
        ...
        {/* Footer */}
        <div className="flex justify-end px-5 py-4 border-t border-gray-100 dark:border-gray-800 flex-shrink-0">
          <button
            onClick={onClose}
            className="px-5 py-2.5 text-sm font-semibold rounded-xl bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white shadow-md transition-all"
          >
            Fechar
          </button>
        </div>
