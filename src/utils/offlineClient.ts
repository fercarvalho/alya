...
//     ao axios — não substitui o interceptor de refresh existente. Detecta
//     ERR_NETWORK e 503 sintético (header x-sw-offline: 1) e dispatcha um
//     event que o banner consome. NÃO engole o erro — só notifica.
//
 ...
 * 401 primeiro; só se ele propagar é que caímos aqui.
 */
