...
// Fase 1.6.4: TabType extraído para @/types/tabType
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-[140px] min-h-screen">
        ...
        {activeTab === "dashboard" && (
          <Dashboard
            ...
            mesesMetas={mesesMetas}
            transactions={transactions}
            calculateTotalsForMonth={calculateTotalsForMonth}
            getProjectionMetasForMonth={getProjectionMetasForMonth}
            getProjectionMetasAnual={getProjectionMetasAnual}
            getMonthYearFromDate={getMonthYearFromDate}
        ...
        {activeTab === "metas" && (
          <Metas
            ...
            exportarMetasPDF={exportarMetasPDF}
            renderMonthContent={renderMonthContent}
            renderMonth={renderMonth}
            renderTotalAno={renderTotalAno}
          />
        )}
        {activeTab === "projecao" && (
          <Suspense
        ...
        {activeTab === "reports" && (
          <Reports
            ...
            setPeriodoRelatorio={setPeriodoRelatorio}
            periodoOffset={periodoOffset}
            setPeriodoOffset={setPeriodoOffset}
            abrirModalSelecaoPeriodo={abrirModalSelecaoPeriodo}
          />
        )}
